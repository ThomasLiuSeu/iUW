jQuery.sap.require("three");
jQuery.sap.require("UCSCharacter");
jQuery.sap.require("datagui");
jQuery.sap.require("orbit");

sap.ui.controller("view.bodyPage",{
  onInit : function() {

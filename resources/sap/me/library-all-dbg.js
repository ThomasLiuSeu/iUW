...
sap.ui.define("sap/me/CalendarDate",['jquery.sap.global'],
	function (jQuery) {
		"use strict";
...
sap.ui.define("sap/me/CalendarRenderer",['jquery.sap.global', './CalendarDate', 'sap/ui/core/LocaleData', 'sap/ui/core/format/DateFormat'],
	function(jQuery, CalendarDate, LocaleData, DateFormat) {
	"use strict";
	 ...
	 * @param {Date} oMonthDate This date must be cloned! The month to render.
	...
	CalendarRenderer._renderMonth = function (oRm, oControl, oMonthDate, sDateNow) {
		...
		var currentDate = new CalendarDate.createDate(oMonthDate.getFullYear(), oMonthDate.getMonth(), oMonthDate.getDate());
		...
		var dateForNbOfDaysInThisMonth = new Date(currentDate.getFullYear(), iCurrentMonth + 1, 0);
...
sap.ui.define("sap/me/Calendar",['jquery.sap.global', './CalendarDate', './library', 'sap/ui/core/Control', 'sap/ui/core/LocaleData', 'sap/ui/core/IconPool'],
	function(jQuery, CalendarDate, library, Control, LocaleData, IconPool) {
	"use strict";
	...
	Calendar.prototype._toggleDatesRangeStyleClass = function (sClass, oDateStart, oDateEnd, bActive) {
		if (typeof oDateStart == "string") {
			...
			oDateStart = CalendarDate.parseFromToDateString(oDateStart);
		}
		if (typeof oDateEnd == "string") {
			// this will change the type of oDateEnd from String to Date.
			oDateEnd = CalendarDate.parseFromToDateString(oDateEnd);
		}
	...
	Calendar.parseDate = function (strDate) {
		...
		return CalendarDate.parseFromToDateString(strDate, true);
	};
	...
	Calendar.prototype._getCalendarFirstDate = function () {
		...
		var oFirstDate = new Date(this._oInternalDate._date.getTime());
...
jQuery.sap.require('sap.ui.core.Control'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.theming.Parameters'); // unlisted dependency retained
sap.ui.define("sap/me/OverlapCalendar",['jquery.sap.global', './Calendar', './library', 'sap/ui/core/Control', 'sap/ui/core/theming/Parameters'],
	function(jQuery, Calendar, library, Control, Parameters) {
	"use strict";

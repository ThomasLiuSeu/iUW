...
if ( !jQuery.sap.isDeclared('sap.uiext.inbox.model.InboxListBinding') ) {
/*!
 * SAP UI development toolkit for HTML5 (SAPUI5)
 * 
 * (c) Copyright 2009-2015 SAP SE. All rights reserved
...
jQuery.sap.require('sap.ui.model.odata.ODataListBinding'); // unlisted dependency retained
...
}; // end of sap/uiext/inbox/model/InboxListBinding.js
...
if ( !jQuery.sap.isDeclared('sap.uiext.inbox.model.InboxCustomModel') ) {
/*!
 * SAP UI development toolkit for HTML5 (SAPUI5)
 * 
 * (c) Copyright 2009-2015 SAP SE. All rights reserved
...
}; // end of sap/uiext/inbox/model/InboxCustomModel.js

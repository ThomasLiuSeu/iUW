	 ...
	 oRm.write(">");
		...
		oRm.write(">");
			...
			oRm.write(">");
				...
				oRm.writeAttribute('title', oControl._oBundle.getText("INBOX_ATTACHMENT_DOWNLOAD_TOOLTIP", [oControl.getFileName()] ));
				oRm.writeAttribute('href', oControl.getDownloadUrl());
				oRm.write('>');
				...
				oRm.writeClasses();
				oRm.writeAttribute('title', oControl.getFileSize());
				oRm.write(">");
			...
			oRm.write(">");
				...
				oRm.writeClasses();
				oRm.writeAttribute('title', oControl._oBundle.getText("INBOX_ATTACHMENT_CREATED_BY_TOOLTIP", [oControl.getCreatedBy()] ));
				oRm.write(">");
				...
				oRm.writeClasses();
				oRm.writeAttribute('title', oControl._oBundle.getText("INBOX_ATTACHMENT_CREATION_DATE_TOOLTIP", [oControl.getCreationDate()] ));
				oRm.write(">");

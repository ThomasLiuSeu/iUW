 ...
 * The scaling factor that is displayed after the total value.
 *
 * Default value is empty/<code>undefined</code>
 *
 ...
 * If set to true, the total value is displayed near the pie chart. Default is true.
 *
 ...
 * If set to true, the fraction values are displayed near the pie chart. Default is true.
 *
 * Default value is <code>true</code>
 *
...
/**
 * The event is fired when the user chooses the Harvey ball micro chart.
 *

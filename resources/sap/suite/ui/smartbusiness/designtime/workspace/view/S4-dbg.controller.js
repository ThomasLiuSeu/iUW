...
sap.ca.scfld.md.controller.BaseDetailController.extend("sap.suite.ui.smartbusiness.designtime.workspace.view.S4", {
       ...
       onInit : function() {
          ...
          this._initializeConstructorParamsForTile();
          ...
          this.oRouter.attachRouteMatched(function(evt) {
        	  if (evt.getParameter("name") === "evalDetail") {
        		  ...
        		  if(that.oApplicationFacade.evaluationDetails && that.oApplicationFacade.evaluationDetails[that.oApplicationFacade.evaluationIndex]) {
        			  ...
        			  currentEvaluationData = that.metadataRef.getEvaluationById({context:that.evalContext, tags:true, properties:true, filters:true, values:true, noEvaluation: true, model:that.oApplicationFacade.getODataModel()});
       ...
       formObjectForInputParametersAndFilters: function(listOfFilters){
          ...
          var i,j, valuesStr = '', tempObj={};
           ...
           try{
        	   ...
        	   var dataSource =  evalData.ODATA_URL;
...
//                                            	});
       ...
       updateFooterButtons: function(evaluationObj) {
        ...
        _initializeConstructorParamsForTile:function(){
        	this._constructorParamForTile = {
        			"NT": {
        				size:"S",
        				value:"0.0",
        				scale:"M",
		...
		getPreviewTile:function(tileType,context){
			...
			switch(tileType){
				...
				case 'NT': tileContent1 = new sap.suite.ui.commons.NumericContent(this._constructorParamForTile[tileType]);
							break;
				case 'CT': tileContent1 = new sap.suite.ui.commons.ComparisonChart(this._constructorParamForTile[tileType]);
							break;
				
				case 'AT':	tileContent1 =  new sap.suite.ui.commons.BulletChart(this._constructorParamForTile[tileType]);
							break;
				
				case 'TT': 	tileContent1 = new sap.suite.ui.commons.MicroAreaChart(this._constructorParamForTile[tileType]);
							break;
				
				case 'CM':	tileContent1 =  new sap.suite.ui.commons.ComparisonChart(this._constructorParamForTile[tileType]);
							break;
				
				case 'HT':	tileContent1 = new sap.suite.ui.commons.HarveyBallMicroChart(this._constructorParamForTile[tileType]);
							break;
							
				case 'DT-AT': frameType = "TwoByOne";
							  tileContent1 = new sap.suite.ui.commons.NumericContent(this._constructorParamForTile["NT"]);
							  tileContent2 =  new sap.suite.ui.commons.BulletChart(this._constructorParamForTile["AT"]);
							  break;
					
				case 'DT-CT' :frameType = "TwoByOne"; 
							  tileContent1 = new sap.suite.ui.commons.NumericContent(this._constructorParamForTile["NT"]);
							  tileContent2 =  new sap.suite.ui.commons.ComparisonChart(this._constructorParamForTile["CT"]);
							  break;
					
				case 'DT-CM' :frameType = "TwoByOne";
							  tileContent1 = new sap.suite.ui.commons.NumericContent(this._constructorParamForTile["NT"]);
							  tileContent2 =  new sap.suite.ui.commons.ComparisonChart(this._constructorParamForTile["CM"]);
							  break;
					
				case 'DT-TT' :frameType = "TwoByOne";
							  tileContent1 = new sap.suite.ui.commons.NumericContent(this._constructorParamForTile["NT"]);
							  tileContent2 =  new sap.suite.ui.commons.MicroAreaChart(this._constructorParamForTile["TT"]);
							  break;
       ...
       checkForMandatoryParametersForEvaluation: function() {
          ...
          if(evaluationObj.ODATA_URL && evaluationObj.ODATA_ENTITYSET) {
                 this.oData4SAPAnalyticsModel = new sap.ui.model.analytics.odata4analytics.Model(new sap.ui.model.analytics.odata4analytics.Model.ReferenceByURI(evaluationObj.ODATA_URL), null);
    		   ...
    		   content:[
    		            ...
    		            beginButton: new sap.m.Button({
    		            	...
    		            	press:function(){
    		            		...
    		            		sap.suite.ui.smartbusiness.lib.Util.utils.replaceHash({action:"configureSBKPIDrilldown", route:"configureChart", context:evalId+"/"+viewId});
    		            	}
    		            })
    	   });

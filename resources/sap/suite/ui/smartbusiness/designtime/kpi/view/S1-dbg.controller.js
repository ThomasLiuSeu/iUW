...
//		that.localLanguage = this.metadataRef.getLocaleLanguage({model:this.oDataModel});
	...
	saveKpiDetails : function() {
		...
		if (!indicatorPayload.ID) {
			if(this.getView().getModel().getData().TYPE === "KPI"){
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_KPI_ID"));
			}
			else{
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_OPI_ID"));
			}
			successStatus = false;
			return;
		}
		...
		if (!indicatorPayload.INDICATOR.TITLE) {
			if(this.getView().getModel().getData().TYPE === "KPI"){
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_KPI_TITLE"));
			}
			else{
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_OPI_TITLE"));
			}
		...
		if (!(successStatus)||that.byId("kpiId").getValueState() === "Error") {
			if(that.kpiIdEval_reason == "NOT_START_WITH_PERIOD") {
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_CDS_KPI_ID_BEGIN_WITH_PERIOD"));
				that.kpiIdEval_reason = null;
			} else if(that.kpiIdEval_reason == "_START_WITH_PERIOD") {
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_HANA_KPI_ID_BEGIN_WITH_PERIOD"));
				that.kpiIdEval_reason = null;
			} else {
				sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_VALID_KPI_ID"));
			}
			successStatus = false;
			return;
		}
		...
		if(that.byId("kpiOwnerEmail").getValueState() === "Error"){
			sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_VALID_KPI_EMAIL"));
			successStatus = false;
			return;
		}
		
		if(that.byId("semanticObject").getValueState() === "Error"){
			sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_VALID_SEMANTIC_OBJECT"));
			return false;
		}
		...
		if(that.byId("kpiTitle").getValueState() === "Error"){
			sap.suite.ui.smartbusiness.lib.Util.utils.showErrorMessage(that.oResourceBundle.getText("ERROR_ENTER_VALID_KPI_TITLE"));
			return false;
		}

...
sap.suite.ui.smartbusiness.tiles.Comparison.prototype._processDataForComparisonChart= function(data,measure,dimension){
    ...
    for(var i=0;i<data.results.length;i++) {
        ...
        var tempVar = sap.suite.ui.smartbusiness.lib.Util.utils.getLocaleFormattedValue(calculatedValueForScaling, this.oConfig.SCALING, this.oConfig.DECIMAL_PRECISION);

...
sap.suite.ui.smartbusiness.tiles.Numeric.prototype.doProcess = function() {
    ...
    var formatValue = sap.suite.ui.smartbusiness.lib.Util.utils.getLocaleFormattedValue(calculatedValueForScaling, this.EVALUATION_DATA.SCALING,this.EVALUATION_DATA.DECIMAL_PRECISION);
    if(this.EVALUATION_DATA.SCALING == -2){ 

...
sap.suite.ui.smartbusiness.tiles.Bullet.prototype.doProcess = function() {
    ...
    var formattedKpiValue  = sap.suite.ui.smartbusiness.lib.Util.utils.getLocaleFormattedValue(calculatedValueForScaling, this.EVALUATION_DATA.SCALING, this.EVALUATION_DATA.DECIMAL_PRECISION);
    calculatedValueForScaling = Number(this.TARGET_VALUE);
    if(this.EVALUATION_DATA.SCALING == -2)
        calculatedValueForScaling *= 100;
    var formattedTargetValue = sap.suite.ui.smartbusiness.lib.Util.utils.getLocaleFormattedValue(calculatedValueForScaling, this.EVALUATION_DATA.SCALING,this.EVALUATION_DATA.DECIMAL_PRECISION);

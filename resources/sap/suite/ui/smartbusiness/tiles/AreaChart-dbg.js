...
sap.suite.ui.smartbusiness.tiles.AreaChart.prototype._processDataForAreaChart= function(data,type,dimensionName,sMeasure){
    ...
    var formattedFirstYLabel = sap.suite.ui.smartbusiness.lib.Util.utils.getLocaleFormattedValue(calculatedValueForScaling, this.oConfig.SCALING, this.oConfig.DECIMAL_PRECISION);
    ...
    var formattedLastYLabel = sap.suite.ui.smartbusiness.lib.Util.utils.getLocaleFormattedValue(calculatedValueForScaling, this.oConfig.SCALING,this.oConfig.DECIMAL_PRECISION);

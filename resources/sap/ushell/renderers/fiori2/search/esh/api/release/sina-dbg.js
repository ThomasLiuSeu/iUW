...
(function(global) {
    ...
    module.DataSource.prototype = {
         ...
         * @constructs sap.bc.ina.api.sina.base.filter.DataSource
         ...
         * @memberOf sap.bc.ina.api.sina.base.filter.DataSource
         * @instance
         * @param  {sap.bc.ina.api.sina.base.filter.DataSource} the other datasource to be
         ...
         * @return {sap.bc.ina.api.sina.base.filter.DataSourceMetaData} The metadata for this datasource.
         */
    ...
    module.Filter.prototype = {
         ...
         * @instance
         * @return {sap.bc.ina.api.sina.base.filter.DataSource} The data source instance.
         */
         ...
         * @memberOf sap.bc.ina.api.sina.base.filter.Filter
         * @instance
         * @param {sap.bc.ina.api.sina.base.filter.DataSource} dataSource A SINA data source.
         */
    ...
    module.ConditionGroup.prototype = {
        ...
        equals: function(otherConditionGroup) {
            ...
            var allConditionsFoundInOtherCG = [];
...
(function(global) {
    ...
    module.Sina.prototype = {
         ...
         * @memberOf sap.bc.ina.api.sina.base.Sina
         * @instance
         * @param  {sap.bc.ina.api.sina.system.System} sys The system representation.
         * @deprecated SAP HANA SPS 09
         */
    ...
    module.Query.prototype = {
        ...
        addFilterCondition: function(attributeOrFilterCondition, operator, value) {
            if (typeof(attributeOrFilterCondition) === "string") {
                attributeOrFilterCondition = new global.sap.bc.ina.api.sina.impl.inav2.filter.Condition(attributeOrFilterCondition, operator, value);
            }
...
(function(global) {
     ...
     * global fields
     */
    module.record = global.sap.bc.ina.api.sina.proxy.record || {};
    ...
    module.Proxy.prototype = {
        ...
        _checkRecordingURLValues: function() {
            ...
            if (hasURLProperty('demoMode')) {
                ...
                this.properties.demoMode = dataSet;
            }
        },
        ...
        _handleRequestFromRecords: function(request) {
            ...
            var requestHash = this._requestHashValue(request.url, request.data);
            ...
            var findRequest = function(records) {
                ...
                //nothing found
                deferred.reject('could not find recorded demo response for request: ' + JSON.stringify(request));
                return;
            };

            if (module.record.demoData) {
                findRequest(module.record.demoData);
            } else {
                var $ajax = $.ajax({
                    dataType: 'json',
                ...
                if (request.async) {
                    $ajax.done(function(records) {
                        if (records) {
                            module.record.demoData = records;
                            findRequest(records);
                        } else {
                            //nothing found
                            deferred.reject('no demo data found at ' + self.properties.demoMode);
                        }
                    });
                } else {
        ...
        _processRequestBuffer: function() {
            var self = this;
            $.each(this.requestBuffer, function(index, request) {
        ...
        _getXSRFToken: function() {
            ...
            if (!this.xsrfDeferred) {
                this.xsrfRetries++;
                this.xsrfDeferred = $.ajax(this.xsrfRequest);
        ...
        ajax: function(request) {
            ...
            if (this.properties.demoMode) {
                var foundRecords = this._handleRequestFromRecords(request);
                return foundRecords;
            }

            var requestHash;
            if (this.properties.record) {
                requestHash = this._requestHashValue(request.url, request.data);
            }
            ...
            var jqXHR = this._requestWithXSRFToken(request);
        ...
        _recordResponse: function(request, response) {
            ...
            module.record.recordings.push(JSON.stringify(record));
            var uniqRequestArray = function(array) {
                ...
                return array.filter(function(record) {
                    ...
                    //return 1 if not seen, else 0
                    return (seen[k] === 1) ? 0 : seen[k] = 1;
                });
            };

            var recordings = module.record.recordings.slice();
...
(function(global) {
    ...
    /**
     * Returns the root data source, which contains all other data sources.
     * @memberOf sap.bc.ina.api.sina.impl.inav2.filter
     * @return {sap.bc.ina.api.sina.impl.inav2.filter.DataSource} the root datasource.
     */
    module.getRootDataSource = function() {
        return new module.DataSource({
            ObjectName: "$$ALL$$",
            PackageName: "ABAP",
            SchemaName: "",
            Type: "Category"
     ...
     * class datasource metadata
     */
    module.DataSourceMetaData.prototype = $.extend({}, filter.DataSourceMetaData.prototype, {
     ...
     * class datasource
     */
    module.DataSource.prototype = $.extend({}, filter.DataSource.prototype, {
         ...
         * @augments {sap.bc.ina.api.sina.base.filter.DataSource}
     ...
     * class filter
     */
    module.Filter.prototype = $.extend({}, filter.Filter.prototype, {
        ...
        addFilterCondition: function(attribute, operator, value) {
            ...
            if (attribute instanceof module.ConditionGroup) {
                this.defaultConditionGroup.addCondition(attribute);
                return this;
            }
            if ($.type(attribute) === 'object') {
                var props = attribute;
            ...
            this.conditionGroupsByAttribute[local_attribute].addCondition(new module.Condition(local_attribute, local_operator, local_value));
            return this;
        },
        ...
        hasFilterCondition: function(attributeOrFilterCondition, operator, value) {
            if (typeof(attributeOrFilterCondition) === "string") {
                attributeOrFilterCondition = new module.Condition(attributeOrFilterCondition, operator, value);
            }
     ...
     * class condition
     */
    module.Condition.prototype = $.extend(Object.create(filter.Condition.prototype), {
     ...
     * class condition group
     */
    module.ConditionGroup.prototype = $.extend(Object.create(filter.ConditionGroup.prototype), {
...
(function(global) {
     ...
     * global fields
     */
    module.record = global.sap.bc.ina.api.sina.impl.inav2.proxy.record || {};
    module.record.recordings = [];
    /**
     * Receives service calls from data boxes and forwards them to server side, either
     * as single GET requests or as POST with GETs as payload.
...
(function(global) {
    ...
    module.getDataSources = function() {
        return module.doGetDataSources.apply(this, arguments);
    };
    module.getDataSourcesSync = function() {
        return module.doGetDataSourcesSync.apply(this, arguments);
    };
    ...
    base.registerProvider({
        ...
        getRootDataSource: filter.getRootDataSource,
        DataSourceQuery: module.DataSourceQuery,
        getDataSources: module.getDataSources,
        getDataSourcesSync: module.getDataSourcesSync
    });

    /**
     * sina
     */
    module.Sina.prototype = $.extend({}, base.Sina.prototype, {
         ...
         * @this {sap.bc.ina.api.sina.impl.inav2.Sina}
        ...
        _assembleDataSourceQuery: function() {
            var dataSourceQuery = this.createDataSourceQuery();
        ...
        _extractDataSources: function(resultSet) {
            ...
            return this.removeDuplicateDataSources(dataSources);
        },
        ...
        getDataSources: function() {
            ...
            var self = this;
            var dataSourcesDeferred = self._dataSourcesDeferred = new $.Deferred();

            // create datasource query
            var dataSourceQuery = self._assembleDataSourceQuery(self);

            // execute query
            dataSourceQuery.getResultSet().then(function(resultSet) {
                // 1. success
                self._dataSources = self._extractDataSources(resultSet);
                dataSourcesDeferred.resolve(self._dataSources);
            }, function(error) {
                // 2. fail
                if (self._dataSourcesDeferred === dataSourcesDeferred) {
                    self._dataSourcesDeferred = null;
                }
        ...
        getDataSourcesSync: function() {
            ...
            // create datasource query
            var dataSourceQuery = this._assembleDataSourceQuery(this);
            ...
            this._dataSourcesDeferred = $.when(this._dataSources);
    ...
    module.Query.prototype = $.extend({}, {
        ...
        execute: function() {
            ...
            if (!self.jqXHR) {
                self.jqXHR = self._fireRequest(jsonRequest, true);
            }

            var deferredResultSet = $.Deferred();

            self.jqXHR.done(function(data) {
                    var error = self._getInAV2Error(data);
        ...
        executeSync: function() {
            ...
            var jsonRequest = self.createJsonRequest();
            self.system.getServerInfo();
            var data = JSON.parse(self._fireRequest(jsonRequest, false).responseText);
            self._responseJson = data;
     ...
     * class facet
     */
    module.Facet.prototype = $.extend({}, base.Facet.prototype, {
     ...
     * class perspective query
     */
    module.PerspectiveQuery.prototype = $.extend({}, base.PerspectiveQuery.prototype, module.Query.prototype, {
     ...
     * class suggestion query
     */
    module.SuggestionQuery.prototype = $.extend({}, base.SuggestionQuery.prototype, module.Query.prototype, {
     ...
     */
    module.Suggestion2Query.prototype = $.extend({}, base.SuggestionQuery.prototype, module.Query.prototype, {
     ...
     * class chart query
     */
    module.ChartQuery.prototype = $.extend({}, base.ChartQuery.prototype, module.Query.prototype, {
     ...
     * class search query
     */
    module.SearchQuery.prototype = $.extend({}, base.SearchQuery.prototype, module.Query.prototype, {
     ...
     */
    module.DataSourceQuery.prototype = $.extend({}, module.SearchQuery.prototype, {
        ...
        init: function(properties) {
            ...
            systemId = serverInfo.rawServerInfo.ServerInfo.SystemId;
            var searchConnector = systemId + self.system.sapclient() + "~ESH_CONNECTOR~";
...
(function(global) {
    ...
    global.sap.bc.ina.api.sina.expandPackage(global, 'sap.bc.ina.api.sina.impl.odata.filter');

    /**
     * shortcut for own module
     */
    var module = global.sap.bc.ina.api.sina.impl.odata.filter;


    /**
     * Returns the root data source, which contains all other data sources.
     * @memberOf sap.bc.ina.api.sina.impl.odata.filter
     * @return {sap.bc.ina.api.sina.impl.odata.filter.DataSource} the root datasource.
     */
    module.getRootDataSource = function() {
        return new module.DataSource({
            collections: ['bp_crm']
    ...
    module.DataSourceMetaData.prototype = $.extend({}, filter.DataSourceMetaData.prototype, {
         ...
         * Meta data for a data source object.
         * @ignore
         * @constructs sap.bc.ina.api.sina.impl.odata.filter.DataSourceMetaData
         * @augments {sap.bc.ina.api.sina.base.filter.DataSourceMetaData}
         * @param  {Object} properties Configuration object.
         */
        init: function(properties) {
            properties = properties || {};
        ...
        _getMetaData: function(callback) {
            var _this = this;
            var system = global.sap.bc.ina.api.sina.sinaSystem();
            if (system.metadata && callback) {
                this.metaData = system.metadata;
                this.description = this.datasource.collections[0];
                callback(this);
            } else {
                system.getMetadata().done(function(metadata) {
                    _this.metaData = metadata;
                    _this.description = _this.datasource.collections[0];
                    if (callback) {
                        callback(_this);
                    }
                });
        ...
        _getMetaDataSync: function() {
            var system = global.sap.bc.ina.api.sina.sinaSystem();
            this.metaData = system.getMetadataSync();
    ...
    module.DataSource.prototype = $.extend({}, filter.DataSource.prototype, {
        ...
        /**
         * The data source of a query that is a collection in the odata service.
         * @constructs sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @augments {sap.bc.ina.api.sina.base.filter.DataSource}
         * @param  {Object} properties Configuration object that can have the
         * property 'collections'. Which could be either an Array or a String.
         * @param {Array} properties.collections The collections of the odata service to be used
         * @param {String} properties.collections The collections of the odata service to be used
         * @example <caption>Properties object for a collection which has the name 'bp_crm'</caption>
         * {
         *     collections  : ['bp_crm']
         * }
         * @private
        ...
        init: function(properties) {
            properties = properties || {};
            properties.collection = properties.collection || properties.Collection || {};
        ...
        /**
         * Compares this datasource with another datasource.
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @param  {sap.bc.ina.api.sina.impl.odata.filter.DataSource} the other datasource to be
         * compared against this datasource.
         * @return {boolean} true if they are equal, false otherwise
         */
        equals: function(otherDS) {
            if (otherDS instanceof module.DataSource) {
                ...
                var checkArrayEquality = function(a, b) {
                    if (a === b) {
                        return true;
                    }
                ...
                if (!checkArrayEquality(this.getCollections(), otherDS.getCollections())) {
                    return false;
                }
         ...
         * @instance
         * @since SAP HANA SPS 09
         * @param {sap.bc.ina.api.sina.filter.DataSourceMetaData} dataSourceMetaData
         */
        setMetaData: function(dataSourceMetaData) {
            this.metaData = dataSourceMetaData;
        },
        ...
        getMetaData: function(callback) {
            if (!this.metaData) {
                this.metaData = new module.DataSourceMetaData({
                    datasource: this
                });
            }
            this.metaData._getMetaData(callback);
        },
         ...
         * Warning: Calling the function will block the javascript thread until
         * a result has been received.
         * @return {sap.bc.ina.api.sina.impl.odata.filter.DataSourceMetaData} The metadata for this datasource.
         * @ignore
         */
        getMetaDataSync: function() {
            if (!this.metaData) {
                ...
                this.metaData._getMetaDataSync();
            }
            return this.metaData;
        },

        /**
         * Set the odata url for this datasource
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @since SAP HANA SPS 09
         * @param {String} oDataUrl
         */
        setODataUrl: function(oDataUrl) {
            global.sap.bc.ina.api.sina.sys._setODataUrl(oDataUrl);
        },

        /**
         * Get the odata url of this datasource
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @since SAP HANA SPS 09
         * @return {String} odataUrl
         */
        getODataUrl: function() {
            return global.sap.bc.ina.api.sina.sys.getODataUrl();
        },

        /**
         * Set the collection of the datasource
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @since SAP HANA SPS 09
        ...
        setCollection: function(collection) {
            ...
            if ($.type(collection) === 'string') {
                ...
                // if (collections === '$$ALL$$') {
                //     var metadata = this.getMetaDataSync();
                //     var entityTypes = this.metaData.metaData.dataServices.schema[0].entityContainer[0].entitySet;

                //     for (var i = 0; i < entityTypes.length; i++) {
                //         this.collections.push(entityTypes[i].name);
                //     }
                // } else {
                //     if (collections.indexOf(',') > -1) {

                //         //search for collection1, collection2, collection3
                //         collections.trim();
                //         var colArr = collections.split(',');
                //         for (var j = 0; j < colArr.length; j++) {
                //             this.collections.push(colArr[j]);
                //         }
                //     } else {
        ...
        /**
         * Get the collections of the datasource
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @since SAP HANA SPS 09
         * @return {Array} Return an array of used colelctions
         */
        ...
        /**
         * Serialize the datasource parameters for use in url
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @since SAP HANA SPS 09
         * @return {Object} Serialized datasource object
         * @ignore
         */
        toURL: function() {
            return {
                ou: this.getODataUrl(),
                oc: this.getCollection()
            };
        },

        /**
         * Deserialize the url parameters to datasource properties
         * @memberOf sap.bc.ina.api.sina.impl.odata.filter.DataSource
         * @instance
         * @since SAP HANA SPS 09
         * @param  {String} url Serialized url
         * @ignore
         */
        fromURL: function(url) {
            this.setODataUrl(url.ou);
            this.setCollection(url.oc);
        }
    ...
    module.Filter.prototype = $.extend({}, filter.Filter.prototype, {
         ...
         * @constructs sap.bc.ina.api.sina.impl.odata.filter.Filter
         * @augments {sap.bc.ina.api.sina.base.filter.Filter}
         * @param  {Object} properties Configuration object.
         * @private
         * @since SAP HANA SPS 09
        ...
        addFilterCondition: function(attribute, operator, value) {
            ...
            if (this.conditionGroupsByAttribute[attribute] === undefined) {
                this.conditionGroupsByAttribute[attribute] = new filter.ConditionGroup({
                    operator: 'OR'
                });
                this.defaultConditionGroup.addCondition(this.conditionGroupsByAttribute[attribute]);
            }
            this.conditionGroupsByAttribute[attribute].addCondition(new filter.Condition(attribute, operator, value));
     ...
     * class condition
     */
    module.Condition.prototype = $.extend({}, filter.Condition.prototype, {

        /**
         * Creates a new filter condition.
         * @constructs sap.bc.ina.api.sina.impl.odata.filter.Condition
         * @augments {sap.bc.ina.api.sina.base.filter.Condition}
         * @param {String|Object} attribute     Technical identifier of the attribute, as defined in the database.
         * If the type is Object, this object can have properties with the name and value of the arguments.
         * @param {String} operator             Operator of the filter condition. The default value is "=".
...
(function(global) {
     ...
     * create own package
     */
    global.sap.bc.ina.api.sina.expandPackage(global, 'sap.bc.ina.api.sina.impl.odata');

    /**
     * import packages
     */
    var base = global.sap.bc.ina.api.sina.base;
    var filter = global.sap.bc.ina.api.sina.impl.odata.filter;
    var system = global.sap.bc.ina.api.sina.impl.odata.system;

    /**
     * shortcut for own module
     */
    var module = global.sap.bc.ina.api.sina.impl.odata;

    /**
     * list of all implemented classes
     */
    module.Facet = function() {
        this.init.apply(this, arguments);
    };
    ...
    module.DataSourceQueryResultSet = function() {
        this.init.apply(this, arguments);
    };
    ...
    module.Sina.prototype = $.extend({}, base.Sina.prototype, {
        ...
        /**
         * Creates a new instance of SINA that uses an OData service. Use it with
         * the SINA factory {@link sap.bc.ina.api.sina.getSina}
         * @augments {sap.bc.ina.api.sina.base.Sina}
         * @this {sap.bc.ina.api.sina.impl.odata.Sina}
         * @constructs sap.bc.ina.api.sina.impl.odata.Sina
         * @param  {Object} properties Configuration properties for the instance.
         * @since SAP HANA SPS 09
         * @private
         */
        init: function(properties) {
            properties = properties || {};
            this.setSystem(properties.system || new system.ODataSystem(properties));
        },
    ...
    module.Query.prototype = $.extend({}, {
         ...
         *  The base query for chart, search, and suggestions queries.
         *  Use the associated factory methods instead of this class.
         *  @constructs sap.bc.ina.api.sina.impl.odata.Query
         *  @private
         */
        //TODO move to sina base
        // init from sina base
        init: function(properties) {
            this.filter = properties.filter || new filter.Filter({
                dataSource: properties.dataSource
        ...
        _getODataError: function(data) {

            if (data.error) {
                return new base.SinaError({
                    message: "OData Service Error " + data.error.code + ": " + data.error.message,
                    errorCode: data.error.code
                });
            }
        },

        //How does a new filter look like
        setDataSource: function(dataSource) {
            if (dataSource === undefined) {
                return this;
            }
        ...
        /**
         * Returns the result set of the query asynchronously.
         * @memberOf sap.bc.ina.api.sina.impl.odata.Query
         * @instance
         * @param  {function} onSuccess This function is called once  the result has been
         * retrieved from the server. The first parameter of this function is the result set.
         * The result set has the function getElements() . This contains  all result set elements.
        ...
        execute: function() {
            ...
            if (!this.jqXHR) {
                this.jqXHR = this._fireRequest(this._buildRequestUrl(), true);
            }

            var deferredResultSet = $.Deferred();

            this.jqXHR.done(function(data) {
                    var error = _this._getODataError(data);
                    if (data && error) {
                        deferredResultSet.reject(error);
                        return;
                    }
                    var resultSet = new _this.resultSetClass(_this.resultSetProperties);
                    resultSet.setJsonData(data);
                    deferredResultSet.resolve(resultSet);
                })
                .fail(function(error) {
        ...
        executeSync: function() {
            ...
            var data = this._fireRequest(this._buildRequestUrl(), false);
            this._responseJson = data;
            this.resultSet = new this.resultSetClass(this.resultSetProperties);
            ...
            if (data && data.responseText) {
                ...
                this.resultSet.setJsonData(response);
            }
        ...
        _buildRequestUrl: function() {
            ...
            var baseUrl = this.system.oDataUrl;

            // Handle multiple calls over diffrent collections
            var collection = this.filter.getDataSource().collection;

            var searchTerms = '';
            if (this.filter.getSearchTerms().length > 0) {
                searchTerms = '&search=' + this.filter.getSearchTerms();
            }

            var responseAttributes = this._transformResponseAttributesToODataSyntax(this.attributes) || '';
            var filterConditions = this._transformFilterConditionsToODataSyntax(this.filter.getFilterConditions());
            var orderBy = $.isEmptyObject(this.orderBy) ? '' : this._assembleOrderBy();
            var skip = '&$skip=' + this.getSkip();
            var top = '&$top=' + this.getTop();
            var facets = '&facets=all';
            var inlinecount = '&$inlinecount=allpages';
            var outputType = '$format=json';

            return baseUrl + collection + '/?' + outputType + searchTerms + responseAttributes + filterConditions + top + skip + orderBy + facets + inlinecount;
        },
         ...
         * @param  {boolean} async        Should the request be asynchronous?
         */
        _fireRequest: function(requestUrl, async) {
            var request = {
                async: async,
                url: requestUrl,
                contentType: 'application/json',
        ...
        /**
         * Assembles the order-by expression needed for calling odata service.
         * @private
         * @ignore
         * @memberOf sap.bc.ina.api.sina.impl.odata.Query
         * @instance
        ...
        _assembleOrderBy: function() {
            ...
            var orderByToODataSyntax = function(orderBy, sortOrder) {
                var odataString = orderBy + ' ';
                odataString += sortOrder;
                return odataString;
            };
            ...
            if ($.type(this.orderBy) === 'array') {
                for (var i = 0; i < this.orderBy.length; i++) {
                    if (i === 0) {
                        orderByString += orderByToODataSyntax(this.orderBy[i].orderBy, this.orderBy[i].sortOrder);
                        continue;
                    }
                    orderByString += ',' + orderByToODataSyntax(this.orderBy[i].orderBy, this.orderBy[i].sortOrder);
                }
            } else if ($.type(this.orderBy) === 'object' && this.orderBy.orderBy) {
                orderByString += orderByToODataSyntax(this.orderBy.orderBy, this.orderBy.sortOrder);
            }

            return orderByString;
        },

        _transformFilterConditionsToODataSyntax: function(conditionGroup) {
            if (typeof conditionGroup === 'object' && conditionGroup.conditions.length > 0) {

                var retUrlPart = '&$filter=';
                var conditionGroupOperator = conditionGroup.operator;

                var transformConditionGroup = function(retUrlPart, conditionGroup, conditionGroupOperator) {

                    var conditions = conditionGroup.conditions;

                    if (conditionGroup.attribute !== undefined) {
                        retUrlPart += conditionGroup.attribute + ' ';
                        ...
                        retUrlPart += "'" + conditionGroup.value + "'";
                        retUrlPart += ' ' + conditionGroupOperator + ' ';

                        return retUrlPart;
                    }

                    for (var i = 0; i < conditions.length; i++) {
                        global.console.log(retUrlPart);
                        retUrlPart += transformConditionGroup('', conditions[i], conditionGroupOperator);
                    }
                    return retUrlPart;
                };

                var filterCond = transformConditionGroup('', conditionGroup, conditionGroupOperator.toLowerCase());
                filterCond = filterCond.substring(0, filterCond.lastIndexOf('and')).trim();
                retUrlPart += filterCond;
        ...
        _transformResponseAttributesToODataSyntax: function(attributes) {
            if (attributes && attributes.length > 0) {
                var retUrlPart = '&$select=';

                for (var i = 0; i < attributes.length; i++) {
                    if (i === 0) {
                        retUrlPart += attributes[i];
                        continue;
                    }
                    retUrlPart += ',' + attributes[i];
                }
    ...
    module.SearchQuery.prototype = $.extend({}, base.SearchQuery.prototype, module.Query.prototype, {
        ...
        /**
         * A query that yields results suitable for a simple result list.
         * @constructs sap.bc.ina.api.sina.impl.odata.SearchQuery
         * @augments {sap.bc.ina.api.sina.base.SearchQuery}
         * @augments {sap.bc.ina.api.sina.impl.odata.Query}
         * @private
         */
        init: function(properties) {
            properties = properties || {};
         ...
         * attribute is returned if the search term was found in one of the
         * response attributes.
         * @memberOf sap.bc.ina.api.sina.impl.odata.SearchQuery
         * @instance
         * @param {String|Object} attribute If the argument is a string, it is
         * the name of an attribute of the database view. If it is an object, it can contain
         * the name of the attribute and additional server-side
         * functions, like snippet or highlighting.
         * See {@link sap.bc.ina.api.sina.impl.odata.Sina#createSearchQuery} for examples.
         */
        addResponseAttribute: function(attribute) {
            this.attributes.push(attribute);
            this._resetResultSet();
    ...
    module.SearchResultSet.prototype = {
        ...
        /**
         * A result set suitable for a simple result list. An instance of this
         * class will be returned by {@link sap.bc.ina.api.sina.impl.odata.SearchQuery#getResultSet}
         * @ignore
         * @constructs sap.bc.ina.api.sina.impl.odata.SearchResultSet
         * @private
         */
        init: function(properties) {
            properties = properties || {};
        ...
        setJsonData: function(data) {
            ...
            if (data && data.d) {
                ...
                this.totalcount = respData.__count;

                var parseResultElement = function(data, container) {
                    /* jshint loopfunc:true */
                    var buildItem = function(index, key) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        resItem['$$RelatedActions$$'] = {};

                        $.each(keys, buildItem);
                        resItem['$$RenderingTemplateSpecification$$'] = {
                            uri: "resulttemplate-detail"
                        };
                        resItem['$$RelatedActions$$']['$$DETAILS$$'] = {
                            request: {
                                resultSet: {
                                    elements: [resItem],
                                    getElements: function() {
                        ...
                        container.push(resItem);
                    }
                };

                var keys = Object.keys(respData);
                for (var i = 0; i < keys.length; i++) {
                    if (keys[i].indexOf('result') >= 0) {
                        parseResultElement(respData[keys[i]], this.elements);
                    }
                }
            }
        }
    ...
    module.Facet.prototype = $.extend({}, base.Facet.prototype, {
         ...
         * A facet that is contained in a perspective.
         * @ignore
         * @constructs sap.bc.ina.api.sina.impl.odata.Facet
         */
        init: function(properties) {
            // TODO: make facet general available only in base
            properties = properties || {};
    ...
    module.Perspective.prototype = {
         ...
         *  A perspective.
         *  @ignore
         *  @constructs sap.bc.ina.api.sina.impl.odata.Perspective
         *  @ignore
         */
        init: function(properties) {
            this.chartFacets = [];
        ...
        _findDimension: function(facetData) {
            try {
                var keys = Object.keys(facetData.Items[0]);
                for (var i = 0; i < keys.length; i++) {
                    var posOfLabel = keys[i].indexOf('@com.sap.vocabularies.Common.v1.Label');
                    if (posOfLabel > 0) {
                        return keys[i].substring(0, posOfLabel);
                    }
                }
            } catch (ex) {
                global.console.error('No dimension found!');
            }
        ...
        setJsonData: function(data) {
            //there is always a searchresult
            this.searchFacet = new module.Facet({
                'facetType': 'searchresult'
            });
            this.searchFacet.setJsonData(data);
            this.searchResultSet = this.searchFacet.getQuery().getResultSetSync();

            //facets
            var facets = data.d['@com.sap.vocabularies.Search.v1.Facets'];
            if (facets) {
                for (var j = 0; j < facets.length; j++) {
                    var facetType = this.determineFacetType(facets[j]);
                    var facet = new module.Facet({
                        "facetType": facetType
                    });
                    facet.setJsonData(facets[j]);
                    facet.title = facets[j]['@com.sap.vocabularies.Common.v1.Label'];
                    facet.dimension = this._findDimension(facets[j]);
                    this.chartFacets.push(facet);
                }
            }
        }
    };
    ...
    module.PerspectiveQuery.prototype = $.extend({}, base.PerspectiveQuery.prototype, module.Query.prototype, {
        ...
        /**
         * Creates a perspective query.
         * @constructs sap.bc.ina.api.sina.impl.odata.PerspectiveQuery
         * @param  {Object} properties Configuration object.
         * @augments {sap.bc.ina.api.sina.base.PerspectiveQuery}
         * @augments {sap.bc.ina.api.sina.impl.odata.Query}
         */
        ...
        /**
         * Get perspective
         * @memberOf sap.bc.ina.api.sina.impl.odata.PerspectiveQuery
         * @param  {Function} onSuccess Callback on success
         * @param  {Function} onError   Callback on error
         * @instance
         */
     ...
     * class ChartQuery
     */
    module.ChartQuery.prototype = $.extend({}, base.PerspectiveQuery.prototype, module.Query.prototype, {
        /**
         * A query that yields results suitable for simple chart controls, like
         * pie or bar charts.
         * @ignore
         * @since SAP HANA SPS 09
         * @constructs sap.bc.ina.api.sina.impl.odata.ChartQuery
         * @augments {sap.bc.ina.api.sina.base.ChartQuery}
         * @augments {sap.bc.ina.api.sina.impl.odata.Query}
         * @private
         */
    ...
    module.ChartResultSet.prototype = {
        ...
        /**
         * A result set that yields elements suitable for simple chart controls, like pie or bar charts.
         * @ignore
         * @since SAP HANA SPS 09
         * @constructs sap.bc.ina.api.sina.impl.odata.ChartResultSet
         * @private
         */
        init: function(properties) {
            properties = properties || {};
        ...
        setJsonData: function(data) {
            this._parseFacetElement(data, this.elements);
        },

        _parseFacetElement: function(data, container) {
            var _this = this;
            var facetElements;
            ...
            var buildItem = function(index, key) {
                ...
                if (key === 'Items') {
                    _this._parseResultElement(data[key], _this.elements);
                }
            };
        ...
        _parseResultElement: function(data, container) {
            for (var i = 0; i < data.length; i++) {
                var keys = Object.keys(data[i]);
                var resItem = {};

                for (var j = 0; j < keys.length; j++) {
                    var posOfLabel = keys[j].indexOf('@com.sap.vocabularies.Common.v1.Label');
                    if (posOfLabel > 0) {
                        var value = data[i][keys[j].substring(0, posOfLabel)];
                        var dimension = keys[j].substring(0, posOfLabel);
                        resItem.label = value;
                        resItem.labelRaw = new filter.Condition(dimension, '=', value);
                    }
                }

                resItem.value = data[i]['__Count'];
    ...
    module.SuggestionQuery.prototype = $.extend({}, base.SuggestionQuery.prototype, module.Query.prototype, {
         ...
         * A suggestion query for a SAP HANA system.
         * @ignore
         * @constructs sap.bc.ina.api.sina.impl.odata.SuggestionQuery
         * @augments {sap.bc.ina.api.sina.base.SuggestionQuery}
         * @augments {sap.bc.ina.api.sina.impl.odata.Query}
         * @param  {Object} properties Configuration object.
         * @since SAP HANA SPS 09
         ...
         * @instance
         * @since SAP HANA SPS 09
         * @memberOf sap.bc.ina.api.sina.impl.odata.SuggestionQuery
         * @param {String} attribute The name of the attribute as given in the SAP HANA database.
         **/
        addResponseAttribute: function(attribute) {
            this.attributes.push(attribute);
    ...
    module.SuggestionResultSet.prototype = {
         ...
         * A suggestion result set for a SAP HANA system.
         * @ignore
         * @constructs sap.bc.ina.api.sina.impl.odata.SuggestionResultSet
         * @since SAP HANA SPS 09
         * @private
         */
        init: function() {
    ...
    module.DataSourceQuery.prototype = $.extend({}, module.SearchQuery.prototype, {
        ...
        /**
         * A query that returns all your datasources
         * @constructs sap.bc.ina.api.sina.impl.odata.DataSourceQuery
         * @augments {sap.bc.ina.api.sina.base.SearchQuery}
         * @private
         */
        init: function(properties) {
            properties = properties || {};
            module.SearchQuery.prototype.init.apply(this, arguments);
            this.resultSetClass = module.DataSourceQueryResultSet;

            var metadata = this.system.getMetadataSync();
            var dataSource = properties.dataSource || {
                collections: this.system.getAvailableCollections(metadata) //metadata could be retrieved in getAvailableCollectios
            };
            this.setDataSource(dataSource);
        },

        _buildRequestUrl: function() {
            return this.system.oDataUrl;
        }
    });

    module.DataSourceQueryResultSet.prototype = {
        ...
        setJsonData: function(data) {
            var collections = data.d.EntitySets;


            for (var i = 0; i < collections.length; i++) {
                var resItem = {};
                resItem[collections[i].toUpperCase()] = {
                    label: 'DataSource',
                    value: collections[i],
                    type: 'OData'
                };

                this.elements.push(resItem);
            }
...
(function(global) {
     ...
     */
    var proxy = global.sap.bc.ina.api.sina.proxy;
    var system = global.sap.bc.ina.api.sina.base.system;

    /**
     * create packages
     */
    global.sap.bc.ina.api.sina.expandPackage(global, 'sap.bc.ina.api.sina.impl.odata.system');

    /**
     * shortcut for own module
     */
    var module = global.sap.bc.ina.api.sina.impl.odata.system;

    module.ODataSystem = function() {
        this.init.apply(this, arguments);
    };
     ...
     * class odata system
     */
    module.ODataSystem.prototype = $.extend({}, system.System.prototype, {

        /**
         * Creates a new ODataSystem
         * Needed for the consumption of ODataServices with SInA
         * @constructs sap.bc.ina.api.sina.impl.odata.system.ODataSystem
         * @augments {sap.bc.ina.api.sina.base.system.System}
         * @param  {Object} properties Configuration options for ODataSystem
         * @since SAP HANA SPS 09
         */
        init: function(properties) {
            this.properties = properties || {};
            this.systemType = 'OData';
            this.oDataUrl = this._prepareUrl(this.properties.oDataUrl);
            this.oDataMetadataUrl = this.oDataUrl + '$metadata';
            system.System.prototype.init.apply(this, [this.properties]);
        },
        ...
        _setMetadata: function(meta) {
            var $meta = $(meta);
            this.metadata = {};
            this.metadata.version = $meta.find('Edmx').attr('Version');
            this.metadata.dataServices = {};
            this.metadata.dataServices.dataServiceVersion = $meta.find('DataServices').attr('m:DataServiceVersion');
            this.metadata.dataServices.maxDataServiceVersion = $meta.find('DataServices').attr('m:MaxDataServiceVersion');
            this.metadata.dataServices.schema = [];

            var schemas = $meta.find('Schema');
            for (var i = 0; i < schemas.length; i++) {
                var $schema = $(schemas[i]);
                var schemaObj = {};
                schemaObj.namespace = $schema.attr('Namespace');
                this.metadata.dataServices.schema.push(schemaObj);

                var entityTypes = $schema.find('EntityType');
                var entityContainer = $schema.find('EntityContainer');

                if (entityTypes.length) {
                    schemaObj.association = [];
                    schemaObj.entityType = [];

                    var associations = $schema.find('Association');

                    schemaObj = this._getEntityTypes(associations, entityTypes, schemaObj);
                }

                if (entityContainer.length) {

                    schemaObj = this._getEntityContainer(entityContainer, schemaObj);
                }
            }
        },

        _getEntityTypes: function(associations, entityTypes, schemaObj) {

            schemaObj = this._getAssociations(associations, schemaObj);

            for (var i = 0; i < entityTypes.length; i++) {
                var $et = $(entityTypes[i]);

                var entityType = {};
                entityType.name = $et.attr('Name');
                entityType.key = {};
                entityType.key.propertyRef = [];
                var propRefs = $et.find('PropertyRef');

                for (var j = 0; j < propRefs.length; j++) {
                    var $propRefs = $(propRefs[j]);

                    entityType.key.propertyRef.push({
                        name: $propRefs.attr('Name')
                    });
                }

                entityType.property = [];

                var properties = $et.find('Property');

                for (var k = 0; k < properties.length; k++) {
                    var $prop = $(properties[k]);

                    var property = {};
                    property.name = $prop.attr('Name');
                    property.type = $prop.attr('Type');

                    if ($prop.attr('Nullable')) {
                        property.nullable = $prop.attr('Nullable');
                    }
                    if ($prop.attr('MaxLength')) {
                        property.maxLength = $prop.attr('MaxLength');
                    }
                    if ($prop.attr('FixedLength')) {
                        property.fixedLength = $prop.attr('FixedLength');
                    }
                    if ($prop.attr('Unicode')) {
                        property.unicode = $prop.attr('Unicode');
                    }

                    entityType.property.push(property);
                }

                schemaObj = this._getNavigationProperties(entityType, $et, schemaObj);
            }

            return schemaObj;
        },

        _getAssociations: function(associations, schemaObj) {
            var getPropertyRefs = function(parent, container) {
                var propertyRefs = parent.find('PropertyRef');

                for (var x = 0; x < propertyRefs.length; x++) {
                    var $ref = $(propertyRefs[x]);
            ...
            for (var i = 0; i < associations.length; i++) {
                ...
                var association = {};
                association.end = [];
                association.name = $association.attr('Name');
                association.referentialConstraint = {};
                association.referentialConstraint.dependent = {};
                association.referentialConstraint.principal = {};

                var ends = $association.find('End');
                for (var j = 0; j < ends.length; j++) {
                    var $end = $(ends[j]);

                    var end = {};
                    end.type = $end.attr('Type');
                    end.role = $end.attr('Role');
                    end.multiplicity = $end.attr('Multiplicity');

                    association.end.push(end);
                }

                var refConstraint = $association.find('ReferentialConstraint');
                var principal = $association.find('Principal');
                var dependent = $association.find('Dependent');

                var $principal = $(principal);
                var $dependent = $(dependent);

                association.referentialConstraint.principal.role = $principal.attr('Role');
                association.referentialConstraint.principal.propertyRef = [];
                association.referentialConstraint.dependent.role = $dependent.attr('Role');
                association.referentialConstraint.dependent.propertyRef = [];

                getPropertyRefs($principal, association.referentialConstraint.principal.propertyRef);
                getPropertyRefs($dependent, association.referentialConstraint.dependent.propertyRef);

                schemaObj.association.push(association);
            }

            return schemaObj;
        },

        _getNavigationProperties: function(entityType, $et, schemaObj) {
            entityType.navigationProperty = [];
            var navProps = $et.find('NavigationProperty');
            for (var i = 0; i < navProps.length; navProps++) {
                var $navProp = $(navProps[i]);

                var navProperty = {};
                navProperty.fromRole = $navProp.attr('FromRole');
                navProperty.name = $navProp.attr('Name');
                navProperty.relationship = $navProp.attr('Relationship');
                navProperty.toRole = $navProp.attr('ToRole');

                entityType.navigationProperty.push(navProperty);
            }

            schemaObj.entityType.push(entityType);
            return schemaObj;
        },

        _getEntityContainer: function(entityContainer, schemaObj) {
            schemaObj.entityContainer = [];
            for (var l = 0; l < entityContainer.length; l++) {
                var $ec = $(entityContainer[l]);

                var container = {};
                container.associationSet = [];
                container.entitySet = [];

                var assocSets = $ec.find('AssociationSet');

                for (var e = 0; e < assocSets.length; e++) {
                    var $assocSet = $(assocSets[e]);

                    var assocSet = {};
                    assocSet.association = $assocSet.attr('Association');
                    assocSet.name = $assocSet.attr('Name');
                    assocSet.end = [];

                    var ends = $assocSet.find('End');
                    for (var f = 0; f < ends.length; f++) {
                        var $end = $(ends[f]);

                        var end = {};
                        end.entitySet = $end.attr('EntitySet');
                        end.role = $end.attr('Role');

                        assocSet.end.push(end);
                    }

                    container.associationSet.push(assocSet);
                }

                var sets = $ec.find('EntitySet');
                for (var m = 0; m < sets.length; m++) {
                    var $set = $(sets[m]);

                    var set = {};
                    set.entityType = $set.attr('EntityType');
                    set.name = $set.attr('Name');

                    container.entitySet.push(set);
                }

                container.extensions = [];
                var extension = {
                    name: 'tbd',
                    namespace: $ec.attr('xmlns:p6'),
                    value: $ec.attr('p6:LazyLoadingEnabled')
                };

                container.extensions.push(extension);

                container.isDefaultEntityContainer = $ec.attr('m:IsDefaultEntityContainer');
                container.name = $ec.attr('Name');

                schemaObj.entityContainer.push(container);
            }
         ...
         * Returns the metadata for this data source asynchronously from the server.
         * @ignore
         * @memberOf sap.bc.ina.api.sina.impl.odata.system.ODataSystem
         * @instance
         * @since SAP HANA SPS 09
         * @return {Object} Returns a promise which could contains the metadata
         */
        getMetadata: function() {
            ...
            this._fireRequest(true)
                .done(function(data) {
                    _this._setMetadata(data);
                    _this.jqXHR.resolve(_this.metadata);

                })
                .fail(function(err) {
                    _this.jqXHR.reject(err);
                });

            return _this.jqXHR.promise();
        },
         ...
         * Warning: Calling the function will block the javascript thread until
         * a result has been received.
         * @return {Object} The metadata for this odata service.
         */
        getMetadataSync: function() {
            var data = this._fireRequest(false);

            this._setMetadata($.parseXML(data.responseText));
            return this.metadata;
        },

        /**
         * Extracts the available collections for this data source from the metadata.
         * @ignore
         * @memberOf sap.bc.ina.api.sina.impl.odata.system.ODataSystem
         * @instance
         * @since SAP HANA SPS 09
         * @param  {Object} metadata The parsed metadata from the data source
         * @return {Array}          The extracted collections
         */
        getAvailableCollections: function(metadata) {
            var entityTypes = metadata.dataServices.schema[0].entityContainer[0].entitySet;
            var collections = [];

            for (var i = 0; i < entityTypes.length; i++) {
                collections.push(entityTypes[i].name);
            }

            return collections;
        },

        _fireRequest: function(async) {
            var request = {
                async: async,
                type: 'GET',
            ...
            return this.proxy.ajax(request);
        },

        /**
         * Returns the odata url of the system
         * @memberOf sap.bc.ina.api.sina.impl.odata.system.ODataSystem
         * @instance
         * @since SAP HANA SPS 09
         * @return {String} The odata url of the used service
         */
        getODataUrl: function() {
        ...
        /**
         * Set the odata url of the system
         * @memberOf sap.bc.ina.api.sina.impl.odata.system.ODataSystem
         * @instance
         * @since SAP HANA SPS 09
         * @param {String} oDataUrl odata url
         */
        setODataUrl: function(oDataUrl) {
            this.oDataUrl = this._prepareUrl(oDataUrl);
            this.oDataMetadataUrl = this.oDataUrl + '$metadata';
        }
    });
}(window));
...
(function(global) {
    ...
    global.sap.bc.ina.api.sina = $.extend({}, module, module.getSina(module.properties));

...
(function() {
    ...
    sap.m.ListItemBase.extend("sap.ushell.renderers.fiori2.search.controls.SearchResultListItem", {
        ...
        renderImage: function(oRm) {
            var self = this;
            if (self.getImageUrl()) {
                oRm.write('<div class="searchResultListItem-attribute searchResultListItem-image2Container">');
                oRm.write('<div class="searchResultListItem-image searchResultListItem-image2" style="background-image:url(\'');

    ...
    sap.ui.controller("sap.ushell.renderers.fiori2.launchpad.catalog.Catalog", {
        ...
        onTileFooterClick : function (oEvent) {
            ...
            var oBackButton = new sap.m.Button({
                ...
                press : function (oEvent) {
                    ...
                    if (!sap.ui.Device.system.phone) {
                        that.oPopover.setContentHeight(popoverDataSectionHeight + "px");
                    } else {
                    ...
                    that.oPopover.addContent(popoverContainer);
            ...
            if (oModel.getProperty("/enableHelp")) {
                newGroupItem.addStyleClass('help-id-newGroupItem');// xRay help ID
            }
            ...
            oOkBtn = this.createOkButton(oSourceContext, ourModel, popoverData, that, that.oPopover, oNewGroupNameInput, oHeadBar);

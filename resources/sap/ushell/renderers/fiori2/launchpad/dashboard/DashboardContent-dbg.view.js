    ...
    sap.ui.jsview("sap.ushell.renderers.fiori2.launchpad.dashboard.DashboardContent", {
                ...
                if (this.getGroups().length) {
                    if (this.getModel().getProperty("/personalization")) {
                        ...
                        that.uiActions = new sap.ushell.UIActions({
                            ...
                            draggableSelector: ".sapUshellTile[role='link']",
        ...
        _getBeforeContent: function (oController) {
            var addGrpBtn = new sap.m.Button({
                ...
                visible : {
                    parts: ["isGroupLocked", "isDefaultGroup", "/tileActionModeActive"],
                    formatter : function (isGroupLocked, isDefaultGroup, tileActionModeActive) {
                        return (!isGroupLocked && !isDefaultGroup && tileActionModeActive);
                    }
                },
                enabled: {
                    parts: ["/editTitle"],
                ...
                press : [ function (oData) {
                    ...
                    var index = parsePath[parsePath.length - 1];
                    this._publishAsync("launchpad", "createGroupAt", {
        ...
        _getAfterContent: function (oController) {
            var addGrpBtn = new sap.m.Button({
                ...
                press : [ function (oData) {
                    ...
                    this._publishAsync("launchpad", "createGroupAt", {
                        title : sap.ushell.resources.i18n.getText("new_group_name"),
                        location : window.parseInt(index, 10) + 1
                    });
                }, oController]
            }).addStyleClass("sapUshellAddGroupButton");
        ...
        _getTileContainerTemplate : function () {
            ...
            var oTilesContainerTemplate = new sap.ushell.ui.launchpad.TileContainer({
                beforeContent: this._getBeforeContent(this.oController),
                afterContent: this._getAfterContent(this.oController),
                headerActions: groupHeaderActionPanel,
                headerText : "{title}",
                tooltip: "{title}",
                ...
                showDragIndicator: {
                    parts: ['/tileActionModeActive', '/enableDragIndicator', 'isGroupLocked', 'isDefaultGroup'],
                    formatter: function (bIsActionModeActive, bDragIndicator, bIsGroupLocked, bIsDefaultGroup) {
                        return bIsActionModeActive && bDragIndicator && !bIsGroupLocked && !bIsDefaultGroup;
                    }
                },
                showMobileActions: {
                    parts: ['/tileActionModeActive', 'isDefaultGroup'],
                ...
                showIcon: {
                    parts: [ '/isInDrag', '/tileActionModeActive', 'isGroupLocked', 'isDefaultGroup'],
                    formatter: function (bIsInDrag, bIsActionModeActive, bIsGroupLocked, bIsDefaultGroup) {
                        return (bIsGroupLocked && (bIsInDrag || bIsActionModeActive)) || (bIsDefaultGroup && bIsActionModeActive);
                    }
                },
                deluminate: {
                    parts: ['/isInDrag', 'isGroupLocked'],
                    formatter: function (bIsInDrag, bIsGroupLocked) {
                        return bIsGroupLocked && bIsInDrag;
                    }
                },
                showPlaceholder: {
                    parts: ['/tileActionModeActive', 'isGroupLocked', "tiles/length"],
                    formatter: function (bIsActionModeActive, bIsGroupLocked, nTilesCount) {
                        if (bIsGroupLocked) {
                            return false;
                        }
                        if (!this.groupHasVisibleTiles()) {
                            return true;
                        }
                        return bIsActionModeActive;
                    }
                },
                visible: {

    ...
    sap.ushell.adapters.local.LaunchPageAdapter = function (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this.isTileIntentSupported = function(oTile) {
            if (oTile && oTile.properties && oTile.properties.formFactor) {
                ...
                var currentDevice =  oSystem.desktop ? "Desktop" :
                    (oSystem.tablet ? "Tablet" :
                        (oSystem.phone ? "Phone" : undefined));
        ...
        this._getTileView = function (oTile) {
            ...
            if (oTile.tileType) {
                ...
                if (ViewPrototype) {
                    try {
                        oTileView = new ViewPrototype(oTile.properties || {});
                        if(typeof oTileView.attachPress === 'function'){
                            oTileView.attachPress(function(){
                                if(typeof oTileView.getTargetURL === 'function'){
                                    var sTargetURL = oTileView.getTargetURL();
                                    if(sTargetURL){
                                        if(sTargetURL[0] === '#'){

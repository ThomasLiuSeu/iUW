    ...
    sap.ushell.components.factsheet.factory = (function () {
        ...
        thingInspectorFactory = function (sUri, sAnnotationUri, oTI) {
            ...
            if (oGeneralFacet) {
                ...
                for (j = 0; j < oGeneralFacet.Facets.length; j += 1) {
                    oFormLayout = formLayoutFactory(oModel, oGeneralFacet.Facets[j].EntitySet, oGeneralFacet.Facets[j].Content, {High: iFieldsWithPrioHigh,
                           Medium: iFieldsWithPrioMedium, Low: 0}, null).addStyleClass("sapFactsheetUtiTilePadding");
                    if (j > 0) {
            ...
            oDataReadCallback = function (functionParameters) {
                return function (data) {
                    var oJsonModel, oBadge, tableItemFactory, oTitle, oData, oMainInfo, oHLayout, sSetTitle, i, j,
                        oContent, iCount, oVLayoutForLabelValuePairs, aPropertyExtensions, oHLayoutForTitle, oHLayout, oTitleLabel,
            ...
            extractContactsFromBatchRequest = function (oData, sOrder) {
                var k, i, j, aContactResults = [], oContacts = {}, oContactMetadata, fFieldValue, sPhone, sMobile, sFax, sTelephone, sPhoto,
                    sMetadataPhone, sMetadataEmail;

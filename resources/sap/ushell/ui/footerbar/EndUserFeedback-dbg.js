...
(function () {
     ...
     *
     * @name sap.ushell.ui.footerbar.EndUserFeedbackButton
     * @private
     * @since 1.16.0
     */
            ...
            ratingButtons: [
                {
                    ...
                    color: 'ratingLabelFeedbackPositiveText',
                ...
                },
                {
                    ...
                    color: 'ratingLabelFeedbackNeutralText',
                ...
                },
                {
                    ...
                    color: 'ratingLabelFeedbackCriticalText',
                ...
                },
                {
                    ...
                    color: 'ratingLabelFeedbackNegativeText',
    ...
    sap.ushell.ui.footerbar.EndUserFeedback.prototype.ShowEndUserFeedbackDialog = function () {
        ...
        this.oLogoImg = new sap.ui.commons.Image('sapFeedbackLogo', {
            src: sDefaultLogo,
            width: '4.5rem',
            height: '4.5rem',
            visible: {
                path: '/isWithinApp',
                formatter: function (bIsWithinApp) {
                    return !bIsWithinApp;
                }
            }
        });
    ...
    sap.ushell.ui.footerbar.EndUserFeedback.prototype._createTechnicalDataContent = function () {
        ...
        if (sap.ui.Device.os.ios && sap.ui.Device.system.phone) {
            this.oTechnicalInfoBox.addStyleClass("ushellContactSupportFixWidth");
        }
    ...
    sap.ushell.ui.footerbar.EndUserFeedback.prototype.updateModelContext = function () {
        ...
        this.oEndUserFeedbackModel.setProperty('/clientContext/navigationData/applicationInformation', {
            url: (this.currentApp && this.currentApp.url) ? this.currentApp.url.split('?')[0] : (currentPage ? this.translationBundle.getText("flp_page_name") : null),
        ...
        this.oEndUserFeedbackModel.setProperty('/isWithinApp', this.currentApp ? true : false);
    ...
    sap.ushell.ui.footerbar.EndUserFeedback.prototype.getTechnicalInfoContent = function () {
        ...
        aFormContent.push(new sap.m.Text({text: this.translationBundle.getText("loginDetails")}).addStyleClass('ushellContactSupportHeaderInfoText'));
        ...
        aFormContent.push(new sap.m.Text({text: this.translationBundle.getText(this.currentApp ? 'applicationInformationFld' : 'feedbackHeaderText')}).addStyleClass('ushellContactSupportHeaderInfoText').addStyleClass("ushellContactSupportHeaderInfoTextSpacing"));

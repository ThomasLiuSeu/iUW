...
sap.ushell.ui.launchpad.Tile.M_EVENTS = {'press':'press','coverDivPress':'coverDivPress','afterRendering':'afterRendering'};
...
(function () {
    ...
    sap.ushell.ui.launchpad.Tile.prototype.onAfterRendering = function () {
        var coverDiv = this.$().find("div.tileActionLayerDiv"),
            sRGBAvalue;
    ...
    sap.ushell.ui.launchpad.Tile.prototype.onclick = function () {
        if (this.getTileActionModeActive()) {
            // If in ActionMode - invoke the cover DIV press event
            this.fireCoverDivPress({
                id: this.getId()
        ...
        if (bShow) {
            icon = new sap.ui.core.Icon({
                ...
                press: function (oEvent) {
                    sap.ushell.renderers.fiori2.ActionMode._openActionsMenu(oEvent, tileControl);
                    tileControl.addStyleClass('showTileActionsIcon');
            ...
            icon.addStyleClass("tileActionsIconClass");

...
(function () {
    ...
    sap.ushell.ui.launchpad.LoadingDialog.prototype.setPopupVisible = function (bVisible) {
        if (bVisible) {
            this.removeStyleClass("sapUshellLoadingDialogInvisible");
        } else {
            this.addStyleClass("sapUshellLoadingDialogInvisible");
        }
    };

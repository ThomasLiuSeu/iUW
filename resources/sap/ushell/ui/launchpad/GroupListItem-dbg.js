...
(function () {
    ...
    sap.ushell.ui.launchpad.GroupListItem.prototype.onAfterRendering = function () {
        var groupItemDomRef = this.getDomRef();
        ...
        if ((document.documentMode) && (navigator.maxTouchPoints  || navigator.msMaxTouchPoints)) {
            // cancel context menu and touch square in IE10 and
            groupItemDomRef.addEventListener("MSHoldVisual", handleContextMenu, false);
            groupItemDomRef.addEventListener("contextmenu", handleContextMenu, false);
        }

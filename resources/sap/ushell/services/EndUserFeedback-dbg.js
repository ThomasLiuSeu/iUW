...
(function () {
    ...
    sap.ushell.services.EndUserFeedback = function (oAdapter, oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.sendFeedback = function (oEndUserFeedbackData) {
            var sUrl, sNavigationIntent, sAdditionalInformation, sApplicationType, oEndUserFeedbackAdapterData, sFormFactor, sUserId, seMail;
            ...
            oEndUserFeedbackAdapterData = {
                ...
                url: sUrl ? sUrl.replace(/\?.*$/, '') : "", //reason: parameters could contain sensitive data

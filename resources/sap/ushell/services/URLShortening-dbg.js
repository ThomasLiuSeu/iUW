...
(function () {
     ...
     * in the backend via the corresponding adapter (Not yet implemented)
     *
    ...
    sap.ushell.services.URLShortening = function () {
         ...
         * @returns a genrated key iff value is a JSON parseable object,
        ...
        this._replaceSapXAppStateRawWithKeyIfRequired = function(value, oStoreContext) {
            ...
            if (typeof value !== "string" || /^[A-Z0-9]{40}$/.test(value)) {
                // ok (string key) or something unintelligable
                return value;
            }
            try {
        ...
        *
        * 2) attempt to reduce it by replacing
        ...
        * @param {aRetainParameterList} array
        *    an array listing parameternames (in order) which should be preferably
        *    not compacted (=retained in the parameter list),
        *    note that some system parameters may be retained before this list is respects
        * @param {oStoreContext}  Object
        ...
        * @private
        ...
        this.compactHash = function (sUrl, aRetainParameterList, oStoreContext) {
            var oSegments,
                ...
                oUrlParsing,
                sResString,
                aRectifiedRetainParameterList = [this.ABBREV_PARAM_NAME, "sap-xapp-state"];
        ...
        this.checkHashLength = function (oURL) {
            var oSegments,
                ...
                oUrlParsing,
                sResString;
            if (typeof oURL !== "string" || oURL.length < that.URL_LENGTH_LIMIT) {
        ...
        this._cmpByList = function (aArray, oA, oB) {
            var i1,
                i2;
            aArray = aArray || [];
            i1 = aArray.indexOf(oA);
            i2 = aArray.indexOf(oB);
            if (oA === oB) {
                return 0;
            }
            if (i1 >= 0 && i2 >= 0) {
        ...
        this._sortByPriority = function (aList, aRetainParameterList) {
            return aList.sort(this._cmpByList.bind(null, aRetainParameterList));
        };
...
// otherwise key is undefined
         ...
         * @returns {object}
         *   a tripel { key, headParams, tailParams } if split,
        ...
        *    the function to invoke to map Key to a Value
        ...
        *    returned
        * @returns the expanded sUrl, or the original one if expansion did not happen
        * @since 1.28.0
        * @public
        */

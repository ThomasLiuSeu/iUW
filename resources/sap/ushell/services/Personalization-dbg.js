        ...
        if (!this._oUnmodifiableContainer) {
            this._oUnmodifiableContainer = (function () {
                ...
                [ "containsItem",
                    ...
                    if (oContextContainer[sFunctionName]) {
                        oUnmodifiableContainer[sFunctionName] = oContextContainer[sFunctionName].bind(oContextContainer);
                    }
                });
